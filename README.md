This project was made just out of boredom. A basic GUI tool that lets users lock or unlock files using fernet encryption.

### How to use

* Use the **"..."** button to browse for a file.
